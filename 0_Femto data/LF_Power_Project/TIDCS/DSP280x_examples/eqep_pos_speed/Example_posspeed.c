...
// Checkin $Date: April 18, 2007   10:32:15 $
//###########################################################################
//
...
// functions called by Example_280xEqep_posspeed.c.  The position and
// speed calculation steps performed by POSSPEED_Calc() at  SYSCLKOUT = 100 MHz 
// and 60 MHz are described below:
//
...
// If max/base speed = 6000 rpm:  6000 = (32/4000)/[(t2-t1)/(100MHz/128)]  
...
//										  = QCPRDLAT
//
//		        So: 6000 rpm = [32(100MHz/128)*60s/min]/[4000(t2-t1)]
//		             t2-t1 = [32(100MHz/128)*60 s/min]/(4000*6000rpm)           - Equation 5 
//		                   = 63 CAPCLK cycles = maximum (t2-t1) = SpeedScaler
//
// Divide both sides by (t2-t1), and:
//                   1 = 63/(t2-t1) = [32(100MHz/128)*60 s/min]/(4000*6000rpm)]/(t2-t1)
//				     Because (t2-t1) must be < 63 for QPOSCNT increment:
//				     63/(t2-t1) < 1 for CW rotation
//                   And because (t2-t1) must be >-63 for QPOSCNT decrement:
//				     63/(t2-t1)> -1 for CCW rotation
//
//					 speed_pr = 63/(t2-t1) 
//                      or [32(100MHz/128)*60 s/min]/(4000*6000rpm)]/(t2-t1)  - Equation 6
//
// To convert speed_pr to RPM:
// Multiply Equation 6 by 6000rpm:
//                  SpeedRpm_fr  = 6000rpm * [32(100MHz/128)*60 s/min]/[4000*6000rpm*(t2-t1)]
//							                = [32(100MHz/128)*60 s/min]/[4000*(t2-t1)]
...
// instead of 100MHz when calculating SpeedRpm_pr.
// The value for freqScaler_pr becomes: [32*(60MHz/128)*60s/min]/(4000*6000rpm) = 38
