...
// Checkin $Date: April 18, 2007   10:28:54 $
//###########################################################################
//
...
// functions called by Example_280xEqep_freqcal.c.  The frequency calculation
// steps performed by FREQCAL_Calc()at  SYSCLKOUT = 100 MHz and 60 MHz are
// described below:
//
...
//		                   = 313 QCAPCLK cycles = maximum (t2-t1) = freqScaler_pr
//
// Divide both sides by (t2-t1), and:
//                   1 = 313/(t2-t1) = [(100MHz/128)/(2*10kHz/8)]/(t2-t1)
//				     Because (t2-t1) must be <313 (max).
//				     313/(t2-t1) < 1 for all frequencies less than max
//					 freq_pr = 313/(t2-t1) or [(100MHz/128)/(2*10kHz/8)]/(t2-t1)  - Equation 6
// Now within velocity limits, to get back to original velocity equation, Equation 1,
// multiply Equation 6 by 10 kHz:
//                  freqhz_fr (or velocity) = 10kHz*[100MHz/128)/(2*10kHz/8)]/(t2-t1)
//							                = (100MHz/128)*8/[2(t2-t1)]
...
// instead of 100MHz when calculating freqhz_pr.
