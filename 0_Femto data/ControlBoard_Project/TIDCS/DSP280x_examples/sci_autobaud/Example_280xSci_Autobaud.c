...
// Checkin $Date: June 13, 2007   10:28:33 $
//###########################################################################
//
// FILE:	Example_280xSci_Autobaud_.c
//
// TITLE:	DSP280x SCI Autobaud detect example
//
// ASSUMPTIONS:
//
...
interrupt void rxaint_isr(void)     // SCI-A
{
  // Insert ISR Code here
   ...
   // If autobaud detected, we must clear CDC and ABD.
